...
function GetSerie($chatId,$title)
{
		...
		// PRELEVO TRAILER 
			...
			$content_trailer = file_get_contents('https://www.googleapis.com/youtube/v3/search?part=snippet&q='.$title_serie.'serie+tv+ita+official+trailer&key=AIzaSyAiMTE7edL3D-klp0y-nbtyyuv5IGLIlhU&maxResults=25');
			$update_3 = json_decode($content_trailer, TRUE);
