...
function GetSerie($chatId,$title)
{
		...
		$title_film = $update_1["object"]["0"]["data"]["0"]["seriesName"];
		$year_film = $update_1["object"]["0"]["data"]["0"]["firstAired"];
		$network = $update_1["object"]["0"]["data"]["0"]["network"];
		$regista = $update_1["object"]["0"]["data"]["0"]["directors"]["0"]["name"];
		$genere = $update_1["object"]["0"]["data"]["0"]["genres"]["0"];
		$durata = $update_1["object"]["0"]["data"]["0"]["runtime"];
		$premi = $update_1["object"]["0"]["data"]["0"]["awards"]["0"][""];
		$trailer = $update_1["object"]["0"]["data"]["0"]["trailer"]["videoURL"];
		$trama = $update_1["object"]["0"]["data"]["0"]["overview"];
		$locandina = $update_1["object"]["0"]["data"]["0"]["banner"];
