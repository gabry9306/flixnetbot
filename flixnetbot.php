...
function GetSerie($chatId,$title)
{
		...
		if ( $title_film != "" ){
			...
			$content_trama = file_get_contents('http://api.myapifilms.com/imdb/idIMDB?idIMDB='.$id_imdb.'&token=11e08191-2011-4679-9fb6-caaaef23eae7&format=json&language=it&aka=0&business=0&seasons=0&seasonYear=0&technical=0&trailers=1&movieTrivia=0&awards=1&moviePhotos=0&movieVideos=0&actors=1&biography=0&actorActress=0&similarMovies=0&goofs=0&keyword=0&quotes=0&fullSize=0&companyCredits=0&filmingLocations=0');
